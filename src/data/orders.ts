...
export const publicOrders: PublicOrder[] = [
    ...
    {
        id: "ORD-SCHOOL-1925",
        title: "Общеобразовательная школа на 1925 учащихся",
        createdAt: new Date().toISOString(),
        location: "Санкт-Петербург, пос. Парголово, Тихоокеанская ул., участок 4 (южнее дома 16, лит. А)",
        images: ["/orders/static_school.jpg"],
        tags: ["образование"],
    },
    {
        id: "ORD-CONSERVATORY-RESTORE",
        title: "СПб государственная консерватория им. Н.А. Римского-Корсакова — реконструкция и реставрация",
        createdAt: new Date().toISOString(),
    ...
    },
    {
        ...
        title: "Нейрохирургический комплекс НМИЦ им. В.А. Алмазова — строительство",
        createdAt: new Date().toISOString(),
        location: "Санкт-Петербург, Заповедная ул., участок 1 (напротив дома 41, лит. А)",
