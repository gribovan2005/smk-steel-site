...
export const metadata: Metadata = {
  ...
  description: "Плазменная резка металла в Санкт-Петербурге ⚡ Цены от 100 руб/м ⚡ Толщина до 150мм ⚡ Высокая точность ⚡ Быстрые сроки",
  keywords: [
    "плазменная резка",
    "резка металла спб",
      ...
      <main className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Плазменная резка металла любой сложности с высокой точностью. 
                Толщина до 150мм, быстрые сроки выполнения.
              </p>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                ...
                <p className="text-gray-200 mb-4">
                  Плазменная резка — это высокоэффективный метод обработки металлов, 
                  основанный на использовании плазменной дуги. Этот процесс обеспечивает 
                  высокое качество реза с минимальной зоной термического воздействия.
                </p>
                <p className="text-gray-200">
                  Наше современное оборудование позволяет резать металл толщиной до 150мм 
                  с высокой точностью и скоростью. Выполняем как серийные заказы, 
                  так и единичные изделия по чертежам заказчика.
                </p>
              </div>
            </div>
        ...
        <Section className="py-20 bg-gradient-to-r from-blue-900/50 to-purple-900/50">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-6">Нужна плазменная резка?</h2>
            <p className="text-xl text-gray-200 mb-8">
              Быстро и точно режем металл любой сложности
            </p>
