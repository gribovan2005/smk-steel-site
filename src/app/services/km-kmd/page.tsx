...
export const metadata: Metadata = {
    ...
    description:
        "Разработка КМ КМД в Санкт-Петербурге ⚡ Рабочая документация ⚡ Проектирование металлоконструкций ⚡ По ГОСТ и СНиП ⚡ Допуски СРО",
    keywords: [
        "КМ КМД",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Разработка конструкций металлических (КМ) и конструкций металлических деталировочных
                                (КМД). Рабочая документация по ГОСТ и СНиП.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Наша команда проектировщиков имеет большой опыт разработки КМ и КМД для различных
                                    типов зданий и сооружений. Работаем в современных САПР системах с созданием
                                    3D-моделей.
                                </p>
                                <p className="text-gray-200">
                                    Вся документация разрабатывается строго по действующим ГОСТ, СНиП и техническим
                                    регламентам. Имеем допуски СРО на проектирование особо опасных и технически сложных
                                    объектов.
                                </p>
                            </div>
                        </div>
