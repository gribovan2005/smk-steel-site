...
export const metadata: Metadata = {
    ...
    description:
        "Монтаж металлоконструкций в Санкт-Петербурге ⚡ Все допуски СРО ⚡ Опытные монтажники ⚡ Гарантия качества ⚡ Работаем с 2013 года",
    keywords: [
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Профессиональный монтаж зданий и металлоконструкций любой сложности. Все допуски СРО.
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Наша компания выполняет полный комплекс монтажных работ — от легких каркасных зданий
                                    до сложных промышленных объектов. Работаем с собственным автопарком спецтехники и
                                    опытной бригадой монтажников.
                                </p>
                                <p className="text-gray-200">
                                    Имеем все необходимые допуски СРО, страхование ответственности. Выполняем работы
                                    строго по проекту с соблюдением всех требований безопасности и нормативов.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужен монтаж?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Выполним монтажные работы быстро и качественно</p>
