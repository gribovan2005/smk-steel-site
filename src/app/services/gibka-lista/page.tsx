...
export const metadata: Metadata = {
    ...
    description:
        "Гибка листового металла в Санкт-Петербурге ⚡ Цены от 50 руб/гиб ⚡ Толщина до 8мм ⚡ Длина до 3000мм ⚡ Высокая точность",
    keywords: [
        "гибка листа",
        "гибка металла спб",
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Гибка листового металла до 8мм на современном оборудовании. Высокая точность, быстрые
                                сроки выполнения.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Гибка листового металла — это операция деформирования заготовки для получения
                                    изделия нужной формы и размеров. Наше оборудование позволяет выполнять как простые,
                                    так и сложные многогибочные операции.
                                </p>
                                <p className="text-gray-200">
                                    Используем современные листогибочные прессы с ЧПУ, что обеспечивает высокую точность
                                    и повторяемость углов гибки. Изготавливаем детали для вентиляции, кровли, фасадов и
                                    других конструкций.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужна гибка листа?</h2>
