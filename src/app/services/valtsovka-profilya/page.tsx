...
export const metadata: Metadata = {
    ...
    description:
        "Вальцовка профиля в Санкт-Петербурге ⚡ Цены от 2000 руб/пм ⚡ Различные профили ⚡ Радиус до 500мм ⚡ Без сварки стыков",
    keywords: [
        "вальцовка профиля",
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление гнутых профилей и арочных конструкций. Быстрый и недорогой способ создания
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Вальцовка профиля — это быстрый и недорогой способ создания изделия нужной формы без
                                    необходимости сварки стыка. Метод позволяет получить радиусные элементы высокого
                                    качества.
                                </p>
                                <p className="text-gray-200">
                                    Используется для изготовления арочных конструкций, элементов декора, каркасов теплиц
                                    и навесов. Наше оборудование позволяет вальцевать профили различных сечений с
                                    минимальными радиусами изгиба.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужна вальцовка профиля?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Изготовим арочные конструкции без сварных швов</p>
