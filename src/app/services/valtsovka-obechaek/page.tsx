...
export const metadata: Metadata = {
    ...
    description:
        "Вальцовка обечаек в Санкт-Петербурге ⚡ Цены от 15000 руб/тн ⚡ Диаметр до 4000мм ⚡ Толщина до 50мм ⚡ Высокое качество",
    keywords: [
        "вальцовка обечаек",
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление цилиндрических обечаек любого диаметра методом вальцовки. Высокое качество
                                геометрии и точность размеров.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Вальцовка — это процесс придания листовому металлу цилиндрической формы с помощью
                                    специального оборудования. Наши вальцы позволяют обрабатывать листы толщиной до 50мм
                                    с высокой точностью.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем обечайки для нефтегазовой промышленности, машиностроения, энергетики.
                                    Все изделия проходят контроль качества и соответствуют требованиям ГОСТ.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужны обечайки?</h2>
