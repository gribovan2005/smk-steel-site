...
export const metadata: Metadata = {
    ...
    description:
        "Клиенты СМК Сталь - ведущие компании Санкт-Петербурга и России. Отзывы о качестве работ и соблюдении сроков изготовления металлоконструкций.",
    keywords: [
        "клиенты СМК Сталь",
        "отзывы о СМК Сталь",
                ...
                <div className="mx-auto max-w-7xl px-4 py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-300 max-w-3xl mx-auto text-shadow text-lg">
                            Более 10 лет мы работаем с ведущими компаниями России, обеспечивая высокое качество и
                            соблюдение сроков
                        </p>
                    </div>
                    ...
                    <div className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-8 mb-12">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 items-center">
                            {clientLogos.map((logo, index) => (
                                <div
                                    key={index}
                                    className="relative h-24 sm:h-32 w-full flex items-center justify-center"
                                >
                                    <Image
                                        src={logo}
                                        alt={`Клиент ${index + 1}`}
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {clientCategories.map((category, index) => (
                                <div key={category.title} className="text-center">
                                    <div
                                        className={`text-6xl mb-4 ${index === 0 ? "" : index === 1 ? "" : index === 2 ? "" : ""}`}
                                    >
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                ...
                                <p className="text-sm text-gray-300">
                                    100% проектов сдано в оговоренные сроки за последние 3 года
                                </p>
                            </div>
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                <div className="text-4xl mb-4">🎯</div>
                            ...
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                ...
                                <p className="text-sm text-gray-300">
                                    Прямое производство без посредников обеспечивает лучшие цены
                                </p>
                            </div>
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                <div className="text-4xl mb-4">🔧</div>
                                ...
                                <p className="text-sm text-gray-300">
                                    От проектирования до монтажа - все услуги в одном месте
                                </p>
                            </div>
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                <div className="text-4xl mb-4">👥</div>
                            ...
                            <div className="text-center p-6 rounded-lg border border-white/10 bg-black/20">
                                ...
                                <p className="text-sm text-gray-300">
                                    Полный пакет разрешительных документов и допусков СРО
                                </p>
                            </div>
                        </div>
                    </div>
