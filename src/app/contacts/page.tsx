...
export const metadata: Metadata = {
    ...
    description:
        "Контакты СМК Сталь в Санкт-Петербурге. Телефон, адрес офиса и производства. Связаться с производителем металлоконструкций.",
    keywords: [
        "контакты СМК Сталь",
        "телефон СМК Сталь",
        "адрес СМК Сталь",
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        ...
                                        <br />
                                        ул. Мурзинская, д. 11, литера А, офис 701
                                        <br />
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-300 leading-relaxed">
                                        г. Санкт-Петербург
                                        <br />
                                        м. Парнас, ул. Домостроительная 10Б
                                        <br />
