...
export const metadata: Metadata = {
    ...
    description:
        "Портфолио выполненных заказов СМК Сталь. Металлоконструкции для торговых центров, производственных объектов, школ и больниц в Санкт-Петербурге.",
    keywords: [
        "заказы СМК Сталь",
            ...
            <main className="relative py-20">
                <div className="mx-auto max-w-7xl px-4">
                    ...
                    <p className="text-gray-200 text-center mb-12 max-w-3xl mx-auto">
                        Портфолио выполненных проектов СМК Сталь. Мы изготавливаем металлоконструкции для торговых
                        центров, производственных объектов, школ, больниц и других сооружений.
                    </p>
                            ...
                            <div key={o.id} className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-6">
                                <div className="flex items-start justify-between gap-4 flex-wrap">
                                    <div>
                                        ...
                                        {o.clientName && (
                                            <p className="text-sm text-gray-500">Заказчик: {o.clientName}</p>
                                        )}
                                    </div>
                                    {o.tags && o.tags.length ? (
                                        <div className="flex flex-wrap gap-2">
                                            {o.tags.map(t => (
                                                <span
                                                    key={t}
                                                    className="text-xs px-2 py-1 rounded-full border border-white/20 text-gray-200 bg-white/5"
                                                >
                                                    {t}
                                                </span>
                                            ))}
