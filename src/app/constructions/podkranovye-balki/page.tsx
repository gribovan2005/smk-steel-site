...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление подкрановых балок в Санкт-Петербурге ⚡ Цены от 45000 руб/тн ⚡ Для мостовых кранов ⚡ Грузоподъемность до 500т",
    keywords: [
        "подкрановые балки",
        "балки для кранов",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление подкрановых балок для мостовых кранов различной грузоподъемности. Усиленные
                                конструкции для тяжелых режимов работы.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Подкрановые балки — специальные несущие конструкции, по которым передвигаются
                                    мостовые краны. Они воспринимают вертикальные нагрузки от крана и груза, а также
                                    горизонтальные силы торможения и боковые.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем подкрановые балки по индивидуальным проектам с учетом режима работы
                                    крана, его грузоподъемности и пролета. Все изделия имеют крановые рельсы и тормозные
                                    конструкции.
                                </p>
                            </div>
                        </div>
