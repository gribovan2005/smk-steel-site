...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление металлических дымовых труб в Санкт-Петербурге ⚡ Цены от 50000 руб/тн ⚡ Высота до 100м ⚡ Стальные и ферромагнитные",
    keywords: [
        "дымовые трубы",
            ...
            <main className="relative">
                <Section className="py-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Дымовые трубы в Санкт-Петербурге</h1>
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление металлических дымовых труб для промышленных предприятий. Стальные
                                конструкции большой высоты с теплоизоляцией.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Металлические дымовые трубы используются для отвода продуктов сгорания от
                                    промышленных котлов, печей и других технологических установок. Обеспечивают
                                    необходимую тягу и рассеивание выбросов в атмосфере.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем дымовые трубы из жаростойкой стали с учетом температурных деформаций и
                                    сейсмических воздействий. Все конструкции рассчитываются на ветровые нагрузки и
                                    имеют молниезащиту.
                                </p>
                            </div>
                        </div>
