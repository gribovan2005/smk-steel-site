...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление нестандартных металлических изделий в Санкт-Петербурге ⚡ Цены от 60000 руб/тн ⚡ По индивидуальным чертежам ⚡ Любая сложность",
    keywords: [
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление уникальных металлических изделий по индивидуальным чертежам и техническим
                                заданиям. Любая сложность и единичные экземпляры.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Нестандартные металлические изделия — это уникальные конструкции, изготавливаемые по
                                    индивидуальным проектам для решения специфических задач. Каждое изделие требует
                                    особого подхода и мастерства.
                                </p>
                                <p className="text-gray-200">
                                    Наши специалисты имеют большой опыт работы с нестандартными задачами. От эскиза до
                                    готового изделия мы сопровождаем весь процесс, предлагая оптимальные технические
                                    решения.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужно нестандартное решение?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Воплотим любые идеи в металле с высоким качеством</p>
