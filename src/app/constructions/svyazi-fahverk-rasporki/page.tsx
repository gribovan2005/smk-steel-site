...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление связей, фахверка и распорок в Санкт-Петербурге ⚡ Цены от 22000 руб/тн ⚡ Для каркасов зданий ⚡ По проекту",
    keywords: ["связи каркаса", "фахверк", "распорки", "связи зданий спб", "элементы жесткости"],
    openGraph: {
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление элементов пространственной жесткости каркасов зданий. Связи между
                                колоннами, фахверк стен, распорки покрытий.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Связи, фахверк и распорки обеспечивают пространственную жесткость и устойчивость
                                    каркаса здания. Они воспринимают горизонтальные нагрузки от ветра и обеспечивают
                                    общую устойчивость конструкций.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем все виды связевых элементов из уголкового профиля, круглых стержней и
                                    профильных труб. Все узлы соединений рассчитываются в соответствии с действующими
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужны связи и фахверк?</h2>
