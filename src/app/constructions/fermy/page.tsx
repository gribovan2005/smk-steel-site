...
export const metadata: Metadata = {
    ...
    description:
        "Производство металлических ферм в Санкт-Петербурге ⚡ Цены от 25000 руб/тн ⚡ Допуски СРО ⚡ Доставка и монтаж ⚡ Опыт с 2013 года",
    keywords: [
        "фермы металлические",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Производство металлических ферм любой сложности для промышленных и гражданских объектов.
                                Цены от 25000 руб/тн. Допуски СРО.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Металлические фермы — это несущие конструкции, состоящие из стержней, соединенных в
                                    узлах и образующих геометрически неизменяемую систему. Они являются основой для
                                    кровельных покрытий промышленных зданий, торговых центров, спортивных сооружений и
                                    других объектов.
                                </p>
                                <p className="text-gray-200">
                                    Наша компания изготавливает фермы различных типов: треугольные, трапециевидные,
                                    полигональные, арочные и специальные конструкции по индивидуальным проектам.
                                    Используем только качественную сталь с соблюдением всех требований ГОСТ и СНиП.
                                </p>
                            </div>
                        </div>
