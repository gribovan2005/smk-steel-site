...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление электросварного двутавра в Санкт-Петербурге ⚡ Цены от 17000 руб/тн ⚡ Высота до 2000мм ⚡ По чертежам",
    keywords: ["электросварной двутавр", "двутавр спб", "изготовление двутавра", "сварные балки", "двутавровые балки"],
    openGraph: {
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Производство электросварных двутавров нестандартных размеров по индивидуальным чертежам.
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Электросварной двутавр изготавливается путем сварки трех листов: стенки и двух
                                    полок. Это позволяет получить балки нестандартных размеров, которые невозможно
                                    изготовить прокаткой.
                                </p>
                                <p className="text-gray-200">
                                    Используем автоматическую сварку под флюсом, что обеспечивает высокое качество
                                    сварных швов и стабильные геометрические размеры. Все изделия проходят контроль
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужен двутавр?</h2>
