...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление балок перекрытий в Санкт-Петербурге ⚡ Цены от 18000 руб/тн ⚡ Высота до 2000мм ⚡ По проекту ⚡ Доставка и монтаж",
    keywords: [
        "балки перекрытий",
            ...
            <main className="relative">
                <Section className="py-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Балки перекрытий в Санкт-Петербурге</h1>
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление балок перекрытий для многоэтажных зданий и промышленных объектов.
                                Электросварные двутавры любых размеров по проекту.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Балки перекрытий — основные несущие элементы каркаса здания, которые воспринимают
                                    нагрузки от перекрытий и передают их на колонны и стены. Мы изготавливаем балки
                                    различных типов и сечений в зависимости от конструктивной схемы здания.
                                </p>
                                <p className="text-gray-200">
                                    Все балки изготавливаются строго по проекту с учетом всех нагрузок и требований к
                                    прочности. Используем автоматическую сварку, что обеспечивает высокое качество
                                    сварных швов и геометрическую точность.
                                </p>
                            </div>
                        </div>
