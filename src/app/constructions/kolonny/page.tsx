...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление металлических колонн в Санкт-Петербурге ⚡ Цены от 22000 руб/тн ⚡ Высота до 18м ⚡ Сварные и прокатные",
    keywords: ["металлические колонны", "колонны спб", "изготовление колонн", "стальные колонны", "несущие колонны"],
    openGraph: {
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление стальных колонн различных типов для каркасов зданий. Сварные и составные
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Металлические колонны — основные вертикальные несущие элементы каркаса здания,
                                    воспринимающие нагрузки от вышележащих конструкций. Проектируются с учетом всех
                                    видов нагрузок и расчетных сочетаний.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем колонны различных типов и сечений в зависимости от
                                    архитектурно-планировочных решений и величины нагрузок. Все изделия имеют
                                    необходимые опорные узлы и закладные детали.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужны колонны?</h2>
