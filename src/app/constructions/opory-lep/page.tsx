...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление опор линий электропередач в Санкт-Петербурге ⚡ Цены от 35000 руб/тн ⚡ Высота до 110м ⚡ Анкерные и промежуточные",
    keywords: [
        "опоры ЛЭП",
            ...
            <main className="relative">
                <Section className="py-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Опоры ЛЭП в Санкт-Петербурге</h1>
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление металлических опор для линий электропередач. Решетчатые конструкции высотой
                                до 110 метров.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Опоры линий электропередач — высокие решетчатые конструкции для поддержания
                                    воздушных линий электропередач. Обеспечивают надежную передачу электроэнергии на
                                    большие расстояния.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем опоры согласно типовым проектам и индивидуальным техническим условиям.
                                    Все конструкции рассчитываются на климатические нагрузки региона и имеют цинковое
                                    покрытие.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        ...
                        <p className="text-2xl text-gray-200 mb-8">Изготовим надежные опоры для линий электропередач</p>
