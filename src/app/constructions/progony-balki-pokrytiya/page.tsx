...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление прогонов и балок покрытия в Санкт-Петербурге ⚡ Цены от 18000 руб/тн ⚡ По проекту ⚡ Доставка и монтаж",
    keywords: ["прогоны", "балки покрытия", "прогоны спб", "балки покрытия санкт петербург", "изготовление прогонов"],
    openGraph: {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление прогонов и балок покрытия для промышленных зданий и кровельных систем.
                                Надежные несущие элементы по проекту.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Прогоны и балки покрытия — это несущие элементы кровельной системы, которые передают
                                    нагрузки от настила кровли на главные несущие конструкции. Проектируются с учетом
                                    снеговых и ветровых нагрузок.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем прогоны из стандартного и специального профиля, а также составные
                                    балки покрытия больших пролетов. Вся продукция соответствует требованиям СНиП и
                                    имеет антикоррозийную защиту.
                                </p>
                            </div>
                        </div>
