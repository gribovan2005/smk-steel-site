...
export const metadata: Metadata = {
    ...
    description:
        "Приварка статичных болтов в Санкт-Петербурге ⚡ От 400 руб/шт + выезд ⚡ На объекте заказчика ⚡ Опытные сварщики ⚡ Контроль качества",
    keywords: [
        "приварка болтов",
        "статичные болты",
        "приварка болтов спб",
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Услуги по приварке статичных болтов на объекте заказчика. Опытные сварщики с выездом и
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Приварка статичных болтов — специальная сварочная операция для создания неразъемного
                                    соединения болта с металлической конструкцией. Выполняется на объекте заказчика
                                    аттестованными сварщиками.
                                </p>
                                <p className="text-gray-200">
                                    Используем специальные сварочные пистолеты и электроды для приварки. Все работы
                                    выполняются согласно технологическим картам с обязательным контролем качества
                                    сварных соединений.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужна приварка болтов?</h2>
