...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление закладных изделий в Санкт-Петербурге ⚡ Цены от 45000 руб/тн ⚡ Для железобетонных конструкций ⚡ По ГОСТ",
    keywords: [
        "закладные изделия",
        "закладные детали",
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление закладных изделий для железобетонных конструкций. Анкерные пластины,
                                закладные детали по ГОСТ и проекту.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Закладные изделия — металлические элементы, которые закладываются в железобетонные
                                    конструкции при их изготовлении для последующего крепления металлических
                                    конструкций, оборудования или других элементов.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем все типы закладных изделий в строгом соответствии с ГОСТ 23279-2012.
                                    Используем качественную сталь с обязательной антикоррозийной обработкой. Все изделия
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужны закладные изделия?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Изготовим закладные детали по ГОСТ и проекту</p>
