...
export const metadata: Metadata = {
  ...
  description: "Изготовление металлических лестниц, ограждений и площадок в Санкт-Петербурге ⚡ Цены от 30000 руб/тн ⚡ Сварные и сборные",
  keywords: [
      ...
      <main className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Изготовление металлических лестниц, ограждений и площадок 
                для промышленных объектов. Эвакуационные и технологические.
              </p>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                ...
                <p className="text-gray-200 mb-4">
                  Металлические лестницы, ограждения и площадки — важные элементы 
                  безопасности промышленных объектов. Обеспечивают доступ к оборудованию 
                  и эвакуационные пути в соответствии с нормами пожарной безопасности.
                </p>
                <p className="text-gray-200">
                  Изготавливаем конструкции из решетчатого настила, рифленого листа 
                  и перфорированного металла. Все изделия имеют антикоррозийную защиту 
                  и соответствуют требованиям ГОСТ и СНиП.
                </p>
              </div>
            </div>
        ...
        <Section className="py-20 bg-gradient-to-r from-blue-900/50 to-purple-900/50">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-6">Нужны лестницы и площадки?</h2>
            <p className="text-xl text-gray-200 mb-8">
              Обеспечим безопасный доступ к оборудованию
            </p>
