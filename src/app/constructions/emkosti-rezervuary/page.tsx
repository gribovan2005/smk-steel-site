...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление металлических емкостей и резервуаров в Санкт-Петербурге ⚡ Цены от 50000 руб/тн ⚡ Объем до 10000м³ ⚡ По техзаданию",
    keywords: ["металлические емкости", "резервуары", "емкости спб", "стальные резервуары", "промышленные емкости"],
    openGraph: {
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление металлических емкостей и резервуаров различного назначения. Цилиндрические,
                                прямоугольные и специальных форм.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Металлические емкости и резервуары используются для хранения жидкостей, сыпучих
                                    материалов и газов в промышленности, нефтехимии, пищевой и других отраслях.
                                </p>
                                <p className="text-gray-200">
                                    Изготавливаем сосуды под давлением и без давления в соответствии с ТР ТС 032/2013 и
                                    правилами Ростехнадзора. Все изделия проходят гидроиспытания и имеют паспорта
                                    сосудов.
                                </p>
                            </div>
                        </div>
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужны емкости или резервуары?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Изготовим сосуды любого назначения по техзаданию</p>
