...
export const metadata: Metadata = {
    ...
    description:
        "Изготовление пространственных металлоконструкций в Санкт-Петербурге ⚡ Цены от 35000 руб/тн ⚡ Купола, шатры, арки ⚡ Сложная геометрия",
    keywords: [
            ...
            <main className="relative">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-gray-200 mb-8">
                                Изготовление сложных пространственных металлоконструкций. Купола, арки, шатровые
                                покрытия и другие уникальные формы.
                            </p>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <div className="bg-black/30 backdrop-blur p-6 rounded-lg border border-white/10">
                                ...
                                <p className="text-gray-200 mb-4">
                                    Пространственные конструкции — это сложные инженерные сооружения, работающие в трех
                                    измерениях и имеющие криволинейную форму. Они позволяют перекрывать большие пролеты
                                    без промежуточных опор.
                                </p>
                                <p className="text-gray-200">
                                    Разрабатываем и изготавливаем уникальные конструкции с использованием современных
                                    расчетных программ и технологий 3D-моделирования. Каждый проект индивидуален и
                ...
                <Section className="py-20 bg-black-900/30">
                    <div className="text-center">
                        <h2 className="text-6xl font-bold mb-6 text-white">Нужна сложная конструкция?</h2>
                        <p className="text-2xl text-gray-200 mb-8">Реализуем любые архитектурные замыслы в металле</p>
