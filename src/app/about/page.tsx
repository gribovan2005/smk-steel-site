...
export const metadata: Metadata = {
    ...
    description:
        "СМК Сталь - надежный партнер в области производства металлоконструкций с 2013 года. Полный цикл от проектирования до монтажа в Санкт-Петербурге.",
    keywords: [
                    ...
                    <div className="grid gap-8 max-w-4xl mx-auto">
                        <div className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-6">
                            ...
                            <p className="text-gray-300 leading-relaxed mb-4">
                                СМК Сталь — один из лидирующих игроков на рынке производства металлоконструкций с 2013
                                года. Мы предлагаем нашим клиентам полный комплекс услуг в сфере возведения зданий и
                                сооружений различного назначения, которые предполагают использование различных
                                металлоконструкций.
                            </p>
                        ...
                        <div className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-6">
                            ...
                            <p className="text-gray-300 leading-relaxed mb-4">
                                ...
                                оборудования, квалифицированных специалистов и строгому контролю на всех этапах
                                производства.
                            </p>
                            <p className="text-gray-300 leading-relaxed">
