...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: "Изготовление металлоконструкций в Санкт-Петербурге от 18000 руб./ тн",
        siteName: "СМК Сталь",
        images: [{ url: "/welding_3.jpg", width: 1200, height: 630, alt: "СМК Сталь — металлоконструкции" }],
    ...
    twitter: {
        ...
        description: "Изготовление металлоконструкций в Санкт-Петербурге. Полный цикл производства. От 18000 руб/тн.",
        images: [{ url: "/welding_3.jpg", width: 1200, height: 630, alt: "СМК Сталь — металлоконструкции" }],
    },
    icons: {
        icon: "/favicon.ico",
    ...
    metadataBase: new URL("https://smk-steel.ru"),
    formatDetection: {
        telephone: false,
    },
    appleWebApp: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        name: "СМК Сталь",
        url: "https://smk-steel.ru",
        logo: "https://smk-steel.ru/logo.png",
