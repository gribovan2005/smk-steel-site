...
export const metadata: Metadata = {
    ...
    description:
        "Современное оборудование СМК Сталь для производства металлоконструкций. Плазменная резка, гибочные станки, сварочное оборудование.",
    keywords: [
                ...
                <div className="mx-auto max-w-7xl px-4 py-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-300 max-w-3xl mx-auto text-shadow text-lg">
                            Современное высокотехнологичное оборудование для производства качественных
                            металлоконструкций
                        </p>
                    </div>
                    ...
                    <div className="grid gap-8 mb-12">
                        {equipmentList.map((equipment, index) => (
                            ...
                            >
                                <div
                                    className={`grid grid-cols-1 lg:grid-cols-2 gap-8 ${index % 2 === 1 ? "lg:grid-cols-2" : ""}`}
                                >
                            ...
                            <div className="space-y-4 text-gray-300">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm">
                                            Координатно-измерительные машины для контроля размеров
                                        </p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                    ...
                    <div className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-8 mb-12">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="text-center">
                                ...
                                <p className="text-sm2 text-gray-300">
                                    Современные системы ЧПУ обеспечивают точность до ±0.1мм
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="text-orange-400 text-xl font-semibold mb-5">Производительность</div>
                                <p className="text-sm2 text-gray-300">
                                    Автоматизация процессов увеличивает скорость в 3 раза
                                </p>
                            </div>
                            <div className="text-center">
