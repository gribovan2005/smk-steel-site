            ...
            <header className="sticky top-0 z-30 bg-black/80 backdrop-blur border-b border-white/10">
                <div className="mx-auto max-w-7xl px-4 py-4 flex items-center justify-between gap-4">
                    ...
                    <nav className="hidden md:flex items-center gap-5 text-sm font-semibold uppercase">
                        <div className="relative group">
                            ...
                            <div className="absolute left-0 mt-2 w-80 rounded-xl border border-white/10 bg-black/70 backdrop-blur p-3 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <div className="flex flex-col gap-2 text-left normal-case font-normal">
                                    <a
                                        href="#services"
                                        className="link-nav font-semibold border-b border-white/20 pb-2"
                                    >
                                        Все услуги
                                    </a>
                                    {services.map(service => {
                                        ...
                                        return url ? (
                                            <Link
                                                key={service.name}
                                                href={url}
                                                className="link-nav text-sm py-1 hover:text-blue-300 transition-colors"
                                            >
                                                {service.name}
                                            </Link>
                                        ) : null;
                        ...
                        <Link href="/prices" className="link-nav">
                            Цены
                        </Link>
                        ...
                        <Link href="/contacts" className="link-nav">
                            Контакты
                        </Link>
                    </nav>
                    <div className="flex items-center gap-3">
                        <details className="md:hidden">
                            ...
                            <div className="absolute right-4 mt-2 w-72 rounded-xl border border-white/10 bg-black/70 backdrop-blur p-3 flex flex-col gap-1 z-40 max-h-96 overflow-y-auto">
                                ...
                                {[
                                    ...
                                    href.startsWith("/") ? (
                                        <Link key={href} href={href} className="link-nav text-sm py-1">
                                            {label}
                                        </Link>
                                    ) : (
                                        <a key={href} href={href} className="link-nav text-sm py-1">
                                            {label}
                                        </a>
                                    )
                                )}
                                ...
                                <Link href="/about-us" className="link-nav text-sm py-1 font-semibold">
                                    О заводе
                                </Link>
                                <Link
                                    href="/orders"
                                    className="link-nav text-xs py-1 ml-2 text-gray-300 hover:text-white transition-colors"
                                >
                                    Заказы
                                </Link>
                                <Link
                                ...
                                <a href="#services" className="link-nav text-sm py-1 font-semibold">
                                    Все услуги
                                </a>
                                {services.map(service => {
                                    const url = serviceUrls[service.name];
                                ...
                                <div className="text-xs text-gray-400 uppercase tracking-wide mt-3 mb-2">
                                    Конструкции
                                </div>
                                <a href="#constructions" className="link-nav text-sm py-1 font-semibold">
                                    Все конструкции
                                </a>
                                {constructions.map(construction => {
                                    const url = constructionUrls[construction.name];
                    ...
                    <div className="mx-auto max-w-7xl px-4">
                        ...
                        <div className="grid gap-6">
                            {publicOrders.map(o => (
                                <div
                                    key={o.id}
                                    className="rounded-xl border border-white/10 bg-black/30 backdrop-blur p-6"
                                >
                                    <div className="flex items-start justify-between gap-4 flex-wrap">
                                        <div>
                                            ...
                                            {o.clientName && (
                                                <p className="text-sm text-gray-600">Заказчик: {o.clientName}</p>
                                            )}
                                        </div>
                ...
                <section id="lead" className="py-20">
                    <div className="mx-auto max-w-7xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                        <div>
                            ...
                            <p>
                                192012, г. Санкт-Петербург, вн. тер. г. муниципальный округ Рыбацкое, ул. Мурзинская, д.
                                11, литера А, офис 701
                            </p>
                            <a href="#lead" className="mt-4 inline-block btn-outline btn-sm">
                                Связаться
                            </a>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <div className="rounded-xl border border-white/10 overflow-hidden">
                                <div className="p-3 text-sm font-semibold">
                                    Производство — м. Парнас, ул. Домостроительная 10Б
                                </div>
                            ...
                            <div className="rounded-xl border border-white/10 overflow-hidden">
                                <div className="p-3 text-sm font-semibold">
                                    Офис — ул. Мурзинская, д. 11, литера А, офис 701
                                </div>
                                <div className="aspect-[16/9] w-full">
                                    <iframe
                                        className="w-full h-full"
